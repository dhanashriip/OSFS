...
$err="<font color='Black'>Admin Will Contact you soon</font>";	
...
?>
       ...
       <div class="row">
                ...
                <form name="sentMessage" method="post" id="contactForm" novalidate>
                  <?php echo @$err; ?>
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            <label>Message:</label>
                            <textarea rows="10" name="msg" cols="80" class="form-control" id="message" required data-validation-required-message="Please enter your message" maxlength="999" style="resize:none"></textarea>
                        </div>
                    </div>
                    <div id="success"></div>
			...
			<div class="col-md-4" style="margin-top:30px">
                ...
                <p>
                    VIDYA BHARTI MAHAVIDYALY <br>Amravati, India 444601<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: +91 7898676745</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="mailto:name@example.com">name@example.com</a>
                </p>
                <p><i class="fa fa-clock-o"></i> 
                    <abbr title="Hours">H</abbr>: Monday - Saturday: 9:00 AM to 9:00 PM</p>
